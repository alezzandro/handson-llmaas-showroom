...
+
[.bordershadow]
image::01/03-3scale-admin-dashboard.png[width="50%"]
...
* **Backends**: this is where you can see the backends that can be used by your products. You can see that the `granite_3_3_8b_instruct` backend that is used by the `granite_3_3_8b_instruct` product and so on. The `backend` in this case is simply the model `Internal Endpoint` that we look at in the earlier section. 

[.bordershadow]
image::01/03-3scale-section-menu.png[width="50%"]

For now, note the two key items:

* A product named `granite_3_3_8b_instruct` (mapped to your model)
...
+
[.bordershadow]
image::01/03-3scale-signin-button.png[width="50%"]
+
...
+
[.bordershadow]
image::01/03-3scale-signin.png[width="50%"]

Once logged in, you will see the following UI:

[.bordershadow]
image::01/03-3scale-developer-loggedin.png[width="50%"]
...
+
[.bordershadow]
image::01/03-3scale-see-applications.png[width="50%"]
...
+
[.bordershadow]
image::01/03-3scale-create-application.png[width="50%"]
...
+
[.bordershadow]
image::01/03-3scale-key-generated.png[width="50%"]
