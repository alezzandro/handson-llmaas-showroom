...
* Go to your 3Scale Developer Portal dashboard at https://maas.{openshift_cluster_ingress_domain}/[https://maas.{openshift_cluster_ingress_domain}/]

* Click on the `Statistics` tab at the top.
+
[.bordershadow]
image::05/01-statistic_panel.png[width="100%"]

* From the drop-down, select the application you have been using to see detailed metrics: 
+
[.bordershadow]
image::05/01-statistic_metrics.png[width="100%"]
