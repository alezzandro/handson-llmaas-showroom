...
[.bordershadow]
image::02/02-chat_complete_get_tasks.png[width="100%"]
...
+
[.bordershadow]
image::02/02-open-terminal.png[width="100%"]
+
...
* Find the `uri:` line and update it with your Gitea repository URL:
+
[source,yaml,subs="attributes"]
----
...
* **AI Integration**: Direct API calls to a Granite model
...
[source,bash,subs="attributes"]
----
oc exec deployment/task-manager -- curl -X POST https://granite-33-8b-instruct.llm-hosting.svc.cluster.local/v1/chat/completions \
