...
= Generative AI with Parasol AI Studio - A Practical Introduction with OpenShift AI
...
Experience how enterprise AI can be made accessible to everyone through Parasol AI Studio - a specialized platform that eliminates the complexity of AI configuration. Discover automatic provisioning, seamless MaaS integration, and one-click access to powerful AI workbenches including chatbots, document processing, code assistants, and image generation.

=== **Module 4:** Deploying a CPU-Optimized Model
Return to the platform engineer role and deploy a compact language model using CPU-only resources. Learn how to use custom vLLM runtimes optimized for CPU execution, understand the trade-offs between GPU and CPU deployments, and explore cost-effective strategies for running AI workloads at scale without GPU requirements.
...
Each person attending this lab has a limited access to the cluster, just enough to be able to in the exercises in this workshop
